<template>
  ...
  <div style=" margin-left:10%; margin-right:5%">
    <h1 style="margin-top:17vh">Cookies Policy</h1>
    ...
    <ul>
      <li>
        ...
        &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to Shop
        Review.
      </li>
      <li>
        <strong>Cookies</strong>
        means small files that are placed on Your computer, mobile device or any
        other device by a website, containing details of your browsing history
        on that website among its many uses.
      </li>
      <li>
        <strong>Website</strong>
        refers to Shop Review, accessible from
        <a
          href="shopreview.com"
      ...
      <li>
        <strong>You</strong>
        means the individual accessing or using the Website, or a company, or
        any legal entity on behalf of which such individual is accessing or
    ...
    <ul>
      <li>By email: shopreview@gmail.com</li>
    </ul>
  </div>
   <Footer />
</template>
